...
?>
    ...
    <a href='index_tim.php?act=forum_replies_tim&f=<?=$f?>&th=<?=$th?>'><?=stripslashes($thread['title'])?></a>
    </p>
<?
    ...
    $r=mysql_query($SQL);
        ...
        ShowPages($p,$pages,5,"act=forum_replies_tim&f={$f}&th={$th}");
        echo "</b></div>";
...
<td valign=top>
        ...
        <input name="act" type="hidden" value="forum_replies_tim">
