...
<script>
var form_name = 'News';
var text_name = 'NewsText';
</script>
              <textarea ONSELECT="storeCaret(this);" ONCLICK="storeCaret(this);" ONKEYUP="storeCaret(this);" onfocus="initInsertions();" name="NewsText" id="NewsText" rows="45" wrap="VIRTUAL" style="width:95%"></textarea>
              </td>
              <td width="180">
