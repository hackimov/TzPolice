...
if (browser=="Microsoft Internet Explorer")
	{
		var bg_pic = 'i/bgr-powerfield-ie.gif';
	}
else
	{
		var bg_pic = 'i/bgr-powerfield2.gif';
	}
document.write('<td background="'+bg_pic+'" class="repeat">');            
</script>
		<table width="100%" height="76"  border="0" cellpadding="15" cellspacing="0" background="i/bgr-powerfield-right.gif" class="tab-top-right-norepeat">
              <tr>
...
<!-- Online Dengi
<form method="POST" action="http://www.onlinedengi.ru/index.php" target="_blank" style="margin: 0px; padding: 0px">
	<input type="hidden" name="outside_project" value="236">
	<input name="submit" value="Купить Купить золотые монеты" type="image" src="/_imgs/online-dengi2.gif" width="265" height="53" border="0">
</form>
<!--
<br>
<a href="http://totto.timezero.ru/" target="_blank"><img src="/_imgs/bannertotalizator.jpg" width="468" height="60" border="0" alt="Тотализатор TimeZero"></img></a>-->
<!-- Online Dengi end -->
