...
<div align="center">
	<b>
		Перевод персонажа в Особый список
	</b>
</div>
...
<div align="center" style="padding-top:10px;">
	<form target="<?php echo $_mp_targetURL; ?>" method="get">
		...
		<input type="hidden" name="target" value="toSpecial"  />
...
?>
					...
					<input type="hidden" name="target" value="toSpecial"  />
					<input type="hidden" name="operation" value="toSpecial"  />
					<input type="hidden" name="act" value="<? echo $_mp_moduleName; ?>"/>
					<br/><br/>
					<div align="center">
						<table cellspacing="5">
						...
						<br/>
						<input type="submit" value="Перевести в ОС" />
					</div>
					</form>
<?php				
				
			}
		} else if ($in['operation'] == 'toSpecial') {
			changePlayerList($in['nickName'], 1);
			echo "<div align='center' style='padding-top:10px;'>Персонаж <b>".$in['nickName']."</b> переведен в ОС</div>";
		}
	}
?>
