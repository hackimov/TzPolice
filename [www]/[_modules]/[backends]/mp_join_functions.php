		...
		<table width="100%" cellpadding="0" cellspacing="0" border="0">
			...
			<tr>
				<td align="left">
						...
						<tbody>
							<tr>
								<td class="quote-news">
									...
									<br>15 уровень или выше;
									<br>2 фракционное звание Rangers/Invasion или выше;
									<br>звание капитана или выше;
									<br>М3/Фракционный/ПВП комплект брони.
									<br>
									...
									<br>3. Отсутствие любых ЧС.
									<br>4. Конфликтоустойчивость, выдержанность, вежливость.
					...
					<br />
					<b>Причины, по которым кандидатам будет отказано в прохождении службы в органах
			...
			<tr>
				...
				<td background='<?php echo $siteLocation; ?>i/bgr-grid-sand.gif'>
					<input
						type="button"
						name="deleteAccessButton"
						onclick="actualy_del_comment('<?php echo $d['id']; ?>','<?php echo $d['nick']; ?>');"
						value="Уволить">
				</td>
			</tr>
			<?php
