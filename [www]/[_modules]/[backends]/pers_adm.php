...
//            echo ("http://www.timezero.ru/cgi-bin/authorization.pl?login=".urlencode($username)."&ses=".$sid."&city=".$city);
...
<table width="100%" border="0" cellspacing="3" cellpadding="3" align="center">
  ...
  <tr>
    <td bgcolor="#D0BD9D" width="50%">провер€ющий коп</td>
    <td bgcolor="#DBA951"><b><?=stripslashes($tmp['cop'])?></b> (проверено <?=date("d.m.Y H:i", $tmp['ans_time'])?>)</td>
  </tr>
  <tr>
  ...
  <tr>
    <td bgcolor="#D0BD9D">старый пароль </td>
    <td bgcolor="#DBA951"><?=stripslashes($tmp['old_psw'])?></td>
  </tr>
  <tr>
  ...
  <textarea name="comment" style="width: 100%" rows="5" wrap="VIRTUAL" id="r_comment"><?=$tmp['answer']?></textarea>
  </form></td>
  </tr>
</table>
