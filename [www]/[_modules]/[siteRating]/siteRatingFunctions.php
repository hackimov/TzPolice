...
function getStatus($n) {
    switch ($n) {
        case 0:
            return "<img src='http://www.tzpolice.ru/_modules/siteRating/img/statusUnchecked.gif' alt='Не проверено' title='Не проверено' style='cursor: pointer;'>";
        break;
        case 1:
            return "<img src='http://www.tzpolice.ru/_modules/siteRating/img/statusApproved.gif' alt='одобрено' title='одобрено' style='cursor: pointer;'>";
        break;
        case 2:
            return "<img src='http://www.tzpolice.ru/_modules/siteRating/img/statusError.gif' alt='не одобрено' title='не одобрено' style='cursor: pointer;'>";
        break;
    }
}
...
function editSite($id) {
    ...
    if (1) { // Check for inspector
        $form = "<form action='http://www.tzpolice.ru/?act=siterating_admin&action=edit&id=$id&mod=save' method=POST name=editNewSite>
            ...
            <div class=\"calendar_widget\" id=\"calendar_widget\"><iframe id='calendar_widget_iframe' name='calendar_widget_iframe' style=\"border: none;\" width=100% height=100% src=\"http://www.tzpolice.ru/_modules/siteRating/datePicker/calendar_widget.html\"></iframe></div> ";
        return $form;
    }
}
