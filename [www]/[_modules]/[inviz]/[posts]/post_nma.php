<h1>Отчетность по посту на аукционе New Moscow</h1>

<?php
$max_on_post=1; // Лимит сотрудников на посту
...
<?
		echo "
      <a href='?act=post_nma&stats=week'>сводная статистика за текущую неделю</a>
      (сейчас идет <b>".date("W")."</b> неделя)  <BR>
     <!-- <a href='?act=post_nma&stats=week2'>сводная статистика за текущую неделю + оазис</a> 
      (сейчас идет <b>".date("W")."</b> неделя)  <BR>!-->
      <a href='?act=post_nma&stats=day'>сводная статистика за день</a>
