...
<table width='100%' border='0' cellspacing='3' cellpadding='2'>
 <tr>
 	...
 	<strong><a href='/?act=prokachki2&d=edit'>Обработка логов</a></strong> </p></td></tr>
";
...
echo <<<HTML
		...
		<a href="?act=prokachki2&d=edit&restart=1">Перезапустить</a> |
		<a href="?act=prokachki2&d=edit&redownload=1">Попытаться загрузить незагружаемые</a> |
		<a href="?act=prokachki2&d=edit&delete=1">Удалить незагружаемые</a>
...
HTML;
		...
		if ($_REQUEST['queue'] == '1') {
			...
			echo '<div align="left"><a href="?act=prokachki2&d=edit&queue=1">Просмотреть подробную очередь</a></div><br>';
			$dolist = 0;
			while ($d=mysql_fetch_assoc($r)) {
...
HTML;
	...
	<tr>
		...
		<p>
			...
			<strong><a href='/?act=prokachki2&d=find'>Поиск по обработанным</a></strong>
		</p>
	</td>
	</tr>
	";
	...
	if($_REQUEST['d']=='find') {
        ...
        $statuslist = array('Непроверенные','Без нарушений','Прокачки');
		...
		<table cellspacing=5 cellpadding=0>
			<tr bgcolor=#F4ECD4>
				...
				<td align=center>Ник персонажа</td>
