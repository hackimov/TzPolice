...
//  ?act=pa_stats
//  case 'mp_stats': include "_modules/rating_arh/mp_stats.php"; break;	
...
// подключаем все что требуеца
	...
	include_once ($DOCUMENT_ROOT.$path_to_php.'/'.$menu.'/mp_stats_function.php');
...
// начальники
/*	$sSQL = "SELECT `chief` FROM `sd_cops` WHERE `name` = '".AuthUserName."' LIMIT 1;";
...
//	if(AuthUserName=='Odrik' || AuthUserName=='Bo Dun' || AuthUserName=='Stealth' || AuthUserName=='Disya' || AuthUserName=='Atenais' || AuthUserName=='Mike Bor' || AuthUserName=='Любимая Дениски' || AuthUserName=='Dissident' || AuthUserName=='6Labs' || AuthUserName=='deadbeef' || AuthUserName=='FANTASTISH' || $chief=="1"){
