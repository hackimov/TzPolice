...
//	корректировка
	...
	$ctime2 = $time2 = explode(":",$time2);
	$time2 = mktime(23, 59, 59, $time2[1], $time2[0], $time2[2]);
...
//	echo $count_days;
	...
	//===============
		...
		$DATA[0][]=$num/$count_days;
		$DATA[1][]=$num2/$count_days;
		$DATA[2][]=$num3/$count_days;
		$DATA["x"][]=$i1.':'.$i2;
	}
