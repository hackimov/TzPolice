...
<h1>Пользователи архива логов УМО</h1> <?
		...
		$query = "SELECT `user_name`, `restricted_area` FROM `site_users` WHERE `restricted_area` LIKE '%umo_logs%' ORDER BY `user_name`";
...
<form name="add_form" method="post" action="?act=umo_logs_users">
