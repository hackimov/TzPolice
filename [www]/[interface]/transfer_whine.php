...
END;
	...
	$result=mysql_query("UPDATE case_main set case_type=\"".$_POST["case_type"]."\" WHERE case_id=".$_POST["caseid"].";");
	//error_log(date("d.m.Y H:i:s")."UPDATE case_main set case_type=\"".$_POST["case_type"]."\" WHERE case_id=".$_POST["caseid"].";",3,"errlog.txt");
header("HTTP/1.1 303 See other");
header("Location: ".$_POST["returnback"]);
