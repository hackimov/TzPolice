...
class sql_db {
	...
	function sql_query($query = "", $transaction = false) {
		...
		if ($query != "") {
			...
			$this->time_query .= "".substr($total_tdb, 0, 10) > 0.01."" ? "<font color=\"red\"><b>".substr($total_tdb, 0, 10)."</b></font> [".$query."]<br /><br />" : "<font color=\"green\"><b>".substr($total_tdb, 0, 10)."</b></font> [".$query."]<br /><br />";
		}
...
if (!$db->db_connect_id) die("<br /><br /><center>Ïðîáëåìû ñ áàçîé äàííûõ.</center>");


$db2 = new sql_db($dbhost2, $dbuname2, $dbpass2, $dbname2, false);
if (!$db2->db_connect_id) die("<br /><br /><center>Ïðîáëåìû ñ áàçîé äàííûõ 2.</center>");
